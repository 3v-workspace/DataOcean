  ...
  return (
    <div className="container sm:px-10">
      <div className="block xl:grid grid-cols-2 gap-4">
        ...
        <div className="grid grid-rows-100 gap-90 h-screen xl:h-auto flex py-5 xl:py-0 my-10 xl:my-0 relative">
          <div
          ...
          <div className="mx-auto my-auto mb-8 xl:ml-20 xl:absolute bottom-0 left-0 ">
            <div className="text-white xl:text-gray-700">
