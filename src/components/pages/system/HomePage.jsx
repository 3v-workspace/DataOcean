...
const HomePage = ({ history }) => {
  ...
  const initTopKvedPie = () => {
    ...
    if ($('#TopKvedChart').length) {
      const ctx = $('#TopKvedChart')[0].getContext('2d');
      new Chart(ctx, {
        type: 'pie',
        data: {
          labels,
  ...
  const initTopCompanyTypesPie = () => {
    ...
    if ($('#TopCompanyChart').length) {
      const ctx = $('#TopCompanyChart')[0].getContext('2d');
      new Chart(ctx, {
        type: 'pie',
        data: {
          labels,
        ...
        <div className="col-span-12 xxl:col-span-12 grid grid-cols-12 gap-6">
          ...
          <div className="col-span-12 sm:col-span-6 lg:col-span-3 mt-8">
            ...
            <div className="intro-y box p-5 mt-5">
              <canvas className="mt-3" id="TopKvedChart" height="280" />
              <PieChartLegend
          ...
          <div className="col-span-12 sm:col-span-6 lg:col-span-3 mt-8">
            ...
            <div className="intro-y box p-5 mt-5">
              <canvas className="mt-3" id="TopCompanyChart" height="280" />
              <PieChartLegend
