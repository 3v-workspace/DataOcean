      ...
      <div className="col-span-12 lg:col-span-6">
        <div className="intro-y space-y-1 mt-8 box">
          ...
          <div className="pl-5 flex flex-row">
            ...
            <div className="max-w-xl">{DateFormat(data.updated_at, i18n.language)}</div>
          </div>
          <div className="pl-5 flex flex-row">
          ...
          <div className="pl-5 flex flex-row">
            ...
            <div className="max-w-xl">{DateFormat(data.termination_date, i18n.language)}</div>
          </div>
          <div className="pl-5 flex flex-row">
          ...
          <div className="pl-5 flex flex-row">
            ...
            <div className="max-w-xl">{DateFormat(data.date_of_birth, i18n.language)}</div>
          </div>
          <div className="pl-5 flex flex-row">
